...
namespace utils::hook
{
	...
	// Generic near-jmp patch. Used ONLY to redirect this process's own CRT
	// printf to our logging stub - not a game-address hook, so it carries
	// none of the "stale for r5338" risk the rest of this codebase flags.
